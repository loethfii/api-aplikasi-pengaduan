...
export const getMasterKontrakans = async (req,res) =>{
    try{
        const masterkontrakans = await MasterKontrakan.find()
...
export const updateMasterKontrakan = async (req,res)=>{
    try {
        const updatedmasterkontrakan = await MasterKontrakan.updateOne({_id:req.params.id},{$set: req.body})
...
export const deleteMasterKontrakan = async (req,res) =>{
    try{
        const deletedmasterkontrakan = await MasterKontrakan.deleteOne({_id:req.params.id})

...
export const getMasterKendalas = async (req,res) =>{
    try{
        const masterkendalas = await MasterKendala.find()
...
export const updateMasterKendala = async (req,res) => {
    try {
        const updatedmasterkendala = await MasterKendala.updateOne({_id:req.params.id},{$set: req.body})
...
export const deleteMasterKendala = async (req,res)=>{
    try{
        const deletemasterkendala = await MasterKendala.deleteOne({_id:req.params.id})
